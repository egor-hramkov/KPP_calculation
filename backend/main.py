...
from backend.services.calculate_KPD_service import CalculateKPDService
from backend.services.air_resistance_service import AirResistanceService
from backend.services.coefficient_influence_power_on_fuel_consumption_service import \
    CoefficientInfluencePowerOnFuelConsumptionService
from backend.services.coefficient_turnovers_to_fuel_service import CoefficientTurnoversToFuelService
from backend.services.dependence_torque_on_air_resistance_service import DependenceOfTorqueOnAirResistanceService
from backend.services.dynamic_factor_service import DynamicFactorService
from backend.services.fuel_consumption_service import FuelConsumptionService
from backend.services.gear_ratio_service import GearRatioService
from backend.services.power_and_torque import PowerAndTorqueService
from backend.services.rolling_resistance_service import RollingResistanceService
from backend.services.speed_car_service import SpeedCarService
from backend.services.torque_on_wheel_service import TorqueOnWheelService
from backend.services.total_force_wheel_ideal_conditions_service import TotalForceWheelIdealConditionsService
from backend.services.total_resistance_force_movement_service import TotalResistanceForceMovementService
from backend.services.turnovers_wheel_service import TurnoversWheelsService

# загружаем данные с файла конфига
from backend.utils.json_helper import JSONHelper
