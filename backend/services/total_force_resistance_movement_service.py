...
class TotalForceResistanceMovement:
     ...
     def total_force_resistance_movement_hub1(self):
          return self.__calculate_total_force_resistance_movement_hub(self.rolling_resistance_coefficient_hub1, self.air_resistance_hub1)

     @property
     def total_force_resistance_movement_hub2(self):
          return self.__calculate_total_force_resistance_movement_hub(self.rolling_resistance_coefficient_hub2, self.air_resistance_hub2)

     @property
     def total_force_resistance_movement_hub3(self):
          return self.__calculate_total_force_resistance_movement_hub(self.rolling_resistance_coefficient_hub3, self.air_resistance_hub3)

     @property
     def total_force_resistance_movement_hub4(self):
          return self.__calculate_total_force_resistance_movement_hub(self.rolling_resistance_coefficient_hub4, self.air_resistance_hub4)

     @property
     def total_force_resistance_movement_hub5(self):
          return self.__calculate_total_force_resistance_movement_hub(self.rolling_resistance_coefficient_hub5, self.air_resistance_hub5)
